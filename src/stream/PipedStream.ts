...
export class QueueStream<READ_T, WRITE_T = READ_T> extends Stream<READ_T, WRITE_T> {
    constructor(private readonly readQueue: Queue<READ_T>, private readonly writeQueue: Queue<WRITE_T>) {
        super();
    }
