...
export class AddGroupDialog<T extends GroupItem> extends React.Component<
  Props<T>,
  State
> {
  ...
  render() {
    const { open, groupName, onNewGroup, controller } = {
      ...this.props,
      ...this.state,
    };
    return (
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={() => this.handleAddGroup(controller)} autoFocus>
            Add
          </Button>
        </DialogActions>
      </Dialog>
